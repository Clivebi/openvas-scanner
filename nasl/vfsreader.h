...
#define VFS_MALLOC g_malloc0
#define VFS_FREE g_free
...
char*  vfs_file_name(vfs_dir_entry_p entry);

//get all files,count return the vfs_dir_entry_p array size
//return the vfs_dir_entry array
vfs_dir_entry_p *vfs_get_all_files(vfs_handle_p vfs, int *count);
...
//full_path: dir/404.html  lookup 404.html file in  /dir/
vfs_dir_entry_p vfs_lookup(vfs_handle_p vfs,const char *full_path);
...
#define vfs_free_file_content(content) g_free(content)
